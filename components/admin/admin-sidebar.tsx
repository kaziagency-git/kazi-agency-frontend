...
const navGroups = [
  ...
  },
  {
    label: 'Recruitment',
    items: [
      { href: '/admin/jobs', label: 'Job Posts', icon: Briefcase, exact: false },
      { href: '/admin/applications', label: 'Apply List', icon: Users, exact: false },
    ],
  },
];
    ...
    <>
      ...
      <div className="flex h-16 items-center gap-3 px-6 border-b border-sidebar-border shrink-0">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[11px] text-sidebar-foreground/60 mt-0.5">Admin Panel</p>
        </div>
        {onClose && (
          <Button
            variant="ghost"
