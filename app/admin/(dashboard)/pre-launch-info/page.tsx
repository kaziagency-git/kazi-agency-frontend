...
export default function AdminOnboardingListPage() {
  ...
  async function copyLink(form: OnboardingForm) {
    ...
    const link = `${BASE}/pre-launch-form/${form.shareToken}`;
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Create and share pre-launch Pre-Launch Form with clients
          </p>
        </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-16 space-y-3">
              ...
              {search ? (
                ...
                <>
                  <p className="text-sm text-muted-foreground">No Pre-Launch Form yet.</p>
      ...
      <Dialog open={createOpen} onOpenChange={setCreateOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Create Onboarding Form</DialogTitle>
            <DialogDescription>
      ...
      <Dialog open={!!deleteTarget} onOpenChange={() => setDeleteTarget(null)}>
        <DialogContent className="sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              This will permanently delete the onboarding form for{' '}
